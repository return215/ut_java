...
public class Sorting {
    ...
    public Sorting(Scanner scanner) {
        ...
        int[] originalData = {5, 3, 8, 3, 9, 1, 4, 7, 3, 6, 2, 5, 8, 6, 7, 2, 4, 1, 9, 0, 3, 5, 7, 4, 2, 6, 8, 1, 9, 0, 4, 5, 6, 3, 2, 7, 8, 1, 0, 9, 6, 3, 2, 1, 5, 4, 7, 8, 9, 0, 3, 4, 5, 6, 7, 8, 9, 1, 2, 0, 5, 3, 7, 2, 4, 6, 1, 8, 0, 9, 2, 4, 6, 8, 0, 1, 3, 5, 7, 9, 6, 2, 4, 8, 1, 3, 5, 7, 9, 0, 5, 3, 1, 7, 2, 4, 6, 0, 9, 8};
        ...
        System.out.println("| --- sortedData ---- | -- mergeSortData -- | countingSortData -- |");
